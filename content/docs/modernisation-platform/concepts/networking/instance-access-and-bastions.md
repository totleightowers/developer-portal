...
source_path: concepts/networking/instance-access-and-bastions.html.md.erb
...
For most EC2 running modern Linux operating systems, [SSH](https://en.wikipedia.org/wiki/Secure_Shell_Protocol) access will be via [AWS Systems Manager Session Manager (SSM)](https://docs.aws.amazon.com/systems-manager/latest/userguide/session-manager).
...
For instances running older versions of Linux where the [SSM Agent](https://docs.aws.amazon.com/systems-manager/latest/userguide/ssm-agent) can't be installed, we can provide a [bastion host](https://en.wikipedia.org/wiki/Bastion_host).
...
For information on how to connect to instances or Bastions see [Accessing EC2s](../../user-guide/accessing-ec2s).
