...
source_path: user-guide/working-as-a-collaborator.html.md.erb
ingested_at: "2026-02-27T16:18:17.868Z"
---
...
Once you have been [set up as a collaborator](../runbooks/adding-collaborators) you can -
...
- [Deploy infrastructure via GitHub Actions workflows](deploying-your-infrastructure)
...
1. The next step is to create your MFA token as shown in the AWS documentation [here](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_mfa_enable_virtual).

1. With the MFA created you can fully log in and [switch role](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_use_switch-role-console) to the relevant account.
...
You can see the accounts and roles assigned to you [here](https://github.com/ministryofjustice/modernisation-platform-github/blob/main/collaborators.json).
