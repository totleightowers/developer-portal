...
source_path: user-guide/adding-vpc-endpoints.html.md.erb
ingested_at: "2026-02-27T16:18:17.763Z"
---
...
A selection of [AWS VPC Endpoints](https://docs.aws.amazon.com/whitepapers/latest/aws-privatelink/what-are-vpc-endpoints) are supplied by default to member VPCs.
...
You can also follow our guidance on [Viewing Core Account resources as a Member Account Developer](./member-read-only-core-accounts) to review the VPC endpoints in the relevant `core-vpc-*` account.
