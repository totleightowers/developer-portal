...
last_reviewed_on: 2025-11-18
review_in: 6 months
source_repo: ministryofjustice/modernisation-platform
source_path: user-guide/platform-user-roles.html.md.erb
ingested_at: "2026-02-27T16:18:17.859Z"
---
...
These are [defined in code](https://github.com/ministryofjustice/modernisation-platform/tree/main/terraform/environments/bootstrap/single-sign-on) and supplied through [single sign-on](../concepts/environments/single-sign-on).
...
This role is intended for platform teams whose services are hosted on the Modernisation Platform. It is currently used by teams such as Application Processing and the Emergency Containment Platform. In the future other platforms such as Cloud Platform may also make use of this role. As additional platforms migrate to or are hosted on the Modernisation Platform, this role can be assigned to them, with permissions adjusted as needed to suit their specific requirements.

- Almost administrator level access where required
