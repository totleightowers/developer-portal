...
source_path: user-guide/how-to-subscribe-to-ami.html.md.erb
ingested_at: "2026-02-27T16:18:17.850Z"
---
...
4. Approve or extend the license to the **entire AWS Organization** or the specific requesting account as appropriate.
   ![Screenshot of Grant screen in license manager](/images/grantscreen.png)
...
- [AWS License Manager Docs](https://docs.aws.amazon.com/license-manager/latest/userguide/what-is)
- [AWS Marketplace](https://aws.amazon.com/marketplace)
- [AWS Organizations](https://docs.aws.amazon.com/organizations/latest/userguide/orgs_introduction)
