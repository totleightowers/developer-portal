...
title: Using Github Advanced Security & Secret Scanning in Modernisation Platform Environments
last_reviewed_on: 2025-09-15
review_in: 6 months
source_repo: ministryofjustice/modernisation-platform
source_path: user-guide/using-github-advanced-security.html.md.erb
ingested_at: "2026-02-27T16:18:17.865Z"
---
...
Further information on the use of Secret Scanning can be found [here](https://docs.github.com/en/enterprise-cloud@latest/code-security/secret-scanning/introduction/about-secret-scanning)
...
- Access the Code Scanning dashboard [here](https://github.com/ministryofjustice/modernisation-platform-environments/security/code-scanning).  
