...
source_path: user-guide/deploying-your-application.html.md.erb
...
1. Populate it with one or more repos, as can be seen [here.](https://github.com/ministryofjustice/modernisation-platform/blob/main/environments/example.json#L26)
