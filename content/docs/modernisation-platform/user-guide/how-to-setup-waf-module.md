...
source_path: user-guide/how-to-setup-waf-module.html.md.erb
ingested_at: "2026-02-27T16:18:17.849Z"
---
...
You can use the [modernisation-platform-terraform-waf](https://github.com/ministryofjustice/modernisation-platform-terraform-waf) module to create an [AWS WAF (Web Application Firewall)](https://docs.aws.amazon.com/waf/latest/developerguide/what-is-aws-waf) configuration in your account.
...
- [AWS WAF Documentation](https://docs.aws.amazon.com/waf/latest/developerguide/what-is-aws-waf)
- [AWS Firewall Manager Documentation](https://docs.aws.amazon.com/waf/latest/developerguide/fms-chapter)
- [AWS Shield and DDoS Protection](https://docs.aws.amazon.com/waf/latest/developerguide/ddos-overview)
