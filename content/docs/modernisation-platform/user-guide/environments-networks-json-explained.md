...
source_path: user-guide/environments-networks-json-explained.html.md.erb
...
- `secondary_cidr_blocks` is used by the [member-vpc](https://github.com/ministryofjustice/modernisation-platform-terraform-member-vpc) module to create secondary CIDR blocks and additional subnets for VPCs requiring expanded IP address capacity.
