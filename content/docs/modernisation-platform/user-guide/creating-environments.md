...
source_path: user-guide/creating-environments.html.md.erb
ingested_at: "2026-02-27T16:18:17.771Z"
---
...
You can read documentation on available roles [here](./platform-user-roles).

### Environment name

Which environments you wish to use, we provide [core networking](creating-networking) for up to 4 accounts as standard.
...
See [creating networking](creating-networking) for more information on additional features.

### Architecture

You can view our architecture for Environments (AWS accounts) on the [dedicated Environments (AWS accounts) architecture page](../concepts/environments/architecture), which also explains what you get by doing this.
...
- `codeowners` is an **_optional_** list of GitHub slugs if you want specific teams to review code changes before they are released into environments. It is **NOT** generally used. Compare the [Blank example](#blank-example) with [Another example](#another-example) below, to see it is unused.
