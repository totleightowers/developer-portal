...
source_path: user-guide/deploying-your-infrastructure.html.md.erb
ingested_at: "2026-02-27T16:18:17.843Z"
---

# 

Once you have [defined your infrastructure as code](creating-resources) and pushed your changes to the repository you can now deploy your infrastructure.
...
Depending on what [environments](creating-environments) you have, some jobs in the workflow may be commented out if they are not needed. They can be uncommented if more environments are added or safely removed if not needed.
...
For more details information on the workflow and concepts behind it please see the [User Workflow](../concepts/sdlc/user-workflow) concepts guidance.
For instructions on how to run a Terraform plan locally see [here](./running-terraform-plan-locally)
