...
source_path: runbooks/ami-and-ebs-cleanup.html.md.erb
ingested_at: "2026-02-27T16:18:17.725Z"
---
...
This runbook explains how to use the **[AMI and EBS cleanup pipeline](https://github.com/ministryofjustice/modernisation-platform-environments/blob/main/.github/workflows/ami_cleanup.yml)** to identify and remove unused Amazon Machine Images (AMIs) and unattached EBS volumes in Modernisation Platform environments.  
...
4. Click **Run workflow** (top right) and put in the inputs below to start the job

| **Input**         | **Description**                      | **Example**                      |
|-------------------|--------------------------------------|----------------------------------|
| application       | Application short name               | cooker                           |
| environments      | Comma-separated list of environments | development,test,preproduction   |
| cleanup_type      | What to clean: ami, ebs, or both     | both (default)                   |
