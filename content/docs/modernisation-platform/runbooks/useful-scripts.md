...
source_path: runbooks/useful-scripts.html.md.erb
ingested_at: "2026-02-27T16:18:17.753Z"
---
...
| [`internal/find-terraform-workspace.sh`](https://github.com/ministryofjustice/modernisation-platform/blob/main/scripts/internal/find-terraform-workspace.sh)       | This script finds terraform workspaces for an environment when it needs to be [deleted](deleting-an-environment)                                                                                                                                                   | ❌             |
| [`internal/git-commit.sh`](https://github.com/ministryofjustice/modernisation-platform/blob/main/scripts/internal/git-commit.sh)                                   | Checks out a branch named `date-${epoch-time}` and commits files changed in the provided path                                                                                                                                                                           | ❌             |
| [`internal/git-pull-request.sh`](https://github.com/ministryofjustice/modernisation-platform/blob/main/scripts/internal/git-pull-request.sh)                       | Creates a pull request back to `main` from the current checked out branch                                                                                                                                                                                               | ❌             |
