...
source_path: runbooks/manage-an-incident.html.md.erb
ingested_at: "2026-02-27T16:18:17.738Z"
---
...
- **Fix the problem**  
  Work towards resolving the incident.
...
For additional guidance, refer to the [security incident reporting on the intranet](https://intranet.justice.gov.uk/guidance/security/report-a-security-incident/).
...
Please bear in mind that not every incident requires the whole team to be involved (even if they all _want_ to join in).
...
| --------- | -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ |
| AWS       | [Creating a support case](https://docs.aws.amazon.com/awssupport/latest/user/case-management) | On the case, or post in [#ext-aws] (https://moj.enterprise.slack.com/archives/C015UBQ78MR) |
...
- A new incident report should be created and stored in the [Modernisation Platform > Incidents](https://justiceuk.sharepoint.com/:f:/r/sites/msteams_480621/Shared%20Documents/Modernisation%20Platform/Incidents?csf=1&web=1&e=NWZF4q) drive directory. See [an example](https://justiceuk.sharepoint.com/:w:/r/sites/msteams_480621/Shared%20Documents/Modernisation%20Platform/Incidents/mp-incident-2024-10-30-19_17.docx?d=wec1460cd6d8c488599770220b4872abd&csf=1&web=1&e=VpVsC4) of such report.
