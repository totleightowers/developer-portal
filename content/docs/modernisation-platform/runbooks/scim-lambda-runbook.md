...
title: SCIM Lambda Jobs for GitHub & Entra ID
last_reviewed_on: 2025-11-12
review_in: 6 months
source_repo: ministryofjustice/modernisation-platform
source_path: runbooks/scim-lambda-runbook.html.md.erb
...
If you’re looking for user-facing SSO guidance, check out the [Modernisation Platform Single Sign-On User Guide](https://user-guide.modernisation-platform.service.justice.gov.uk/concepts/environments/single-sign-on.html#single-sign-on).
...
For full rotation procedures, including manual steps and validating successful rotation, refer to the [Rotating Secrets Runbook](https://user-guide.modernisation-platform.service.justice.gov.uk/runbooks/rotating-secrets).  
