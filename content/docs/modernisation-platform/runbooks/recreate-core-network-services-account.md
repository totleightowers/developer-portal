...
source_path: runbooks/recreate-core-network-services-account.html.md.erb
ingested_at: "2026-02-27T16:18:17.742Z"
---
...
This can be achieved by triggering core-network-services deployment workflow run, which can be [found here](https://github.com/ministryofjustice/modernisation-platform/actions/workflows/core-network-services-deployment.yml).
...
The baselines job may need to be run multiple times and errors troubleshooted. To manually run baselines, click [here.](https://github.com/ministryofjustice/modernisation-platform/actions/workflows/scheduled-baseline-extended-matrix.yml)
...
- [Disaster Recovery Process](https://user-guide.modernisation-platform.service.justice.gov.uk/runbooks/dr-process)
