...
source_path: runbooks/querying-vpc-flow-logs.html.md.erb
ingested_at: "2026-02-27T16:18:17.741Z"
---

# 

In the course of supporting a [Modernisation Platform customer](https://user-guide.modernisation-platform.service.justice.gov.uk/user-guide/our-offer-to-you)
...
though the [AWS CLI](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/logs/start-query), and in
...
- [Amazon Virtual Private Cloud: Working with flow logs](https://docs.aws.amazon.com/vpc/latest/userguide/working-with-flow-logs)
- [AWS VPC Flow Log fields](https://docs.aws.amazon.com/vpc/latest/userguide/flow-logs)
