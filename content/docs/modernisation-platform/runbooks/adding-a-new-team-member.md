...
source_path: runbooks/adding-a-new-team-member.html.md.erb
...
Submit a pull request and when it's merged, they will appear on [our team page](../team/team).
...
To add them to our GitHub team, update the file at [terraform/github/locals.tf](https://github.com/ministryofjustice/modernisation-platform-github/blob/main/terraform/github/locals.tf) with:
...
> You can view a [sample PR](https://github.com/ministryofjustice/modernisation-platform/pull/382) in case you get stuck. Please note that the sample PR is on the modernisation-platform repository, but the change needs to be made on the modernisation-platform-github repository.
