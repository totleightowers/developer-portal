...
source_path: runbooks/security-monitoring.html.md.erb
ingested_at: "2026-02-27T16:18:17.750Z"
---
...
We actively monitor for security threats using various tools including AWS Security Hub, AWS GuardDuty, AWS Inspector, AWS Config and Security Operations Centre (SOC) Palo Alto Cortex XSIAM.

## Raising a new security issue

New issues should be raised in the internal repository - [modernisation-platform-security](https://github.com/ministryofjustice/modernisation-platform-security) and added to the Modernisation Platform GitHub project. Please note this is for security issues (misconfigurations or practices which need addressing) rather than security incidents. Security incidents should follow our [incident management process](manage-an-incident).

## Security Monitoring

| Monitoring         | Description                                                                                                                                         | How findings are reported                                                                                                                                                                                                                                                                                                 | How to raise an issue                                                                              |
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| AWS Security Hub   | AWS security tool installed on all organisation accounts and configured in the Modernisation Platform Security Baselines repository.                | A summary of Platform alerts go into the #modernisation-platform-security-hub-alerts Slack channel. Additionally applcation teams can request the summary for their own accounts [here](securityhub-slack-notification) They can also be viewed in each individual account or via the organisation-security account. | Platform issues should be raised as above, user issues should be raised with the application team. |
...
Some alerts for certain resources have been suppressed, which can be seen [here](https://github.com/ministryofjustice/aws-root-account/blob/main/modules/securityhub/main.tf#L121) in security hub.
