...
source_path: runbooks/migrating-an-account-into-the-modernisation-platform.html.md.erb
ingested_at: "2026-02-27T16:18:17.739Z"
---
...
You can make use of the [AWS guidance](https://docs.aws.amazon.com/IAM/latest/UserGuide/reset-root-password) to log into the account of interest as the root user.
