...
source_path: runbooks/revoking-user-access.html.md.erb
ingested_at: "2026-02-27T16:18:17.747Z"
---
...
is for non-MOJ employees who require access to AWS. These users are defined in the [collaborators.json](https://github.com/ministryofjustice/modernisation-platform-github/blob/main/collaborators.json) file.
...
Removing access for MP team members is documented [here](https://user-guide.modernisation-platform.service.justice.gov.uk/runbooks/removing-a-team-member)
...
Any PRs raised to remove a users access would need to be approved by a member of the [aws-root-account-admin-team](https://github.com/orgs/ministryofjustice/teams/aws-root-account-admin-team).
