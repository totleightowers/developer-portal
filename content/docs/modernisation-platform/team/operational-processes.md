...
source_path: team/operational-processes.html.md.erb
ingested_at: "2026-02-27T16:18:17.756Z"
---
...
- Monitor and respond to queries in [#ask-modernisation-platform](https://mojdt.slack.com/archives/C01A7QK5VM1)
- Monitor [#modernisation-platform-high-priority-alarms](https://mojdt.slack.com/archives/C03CY6451QT) for incidents
- Check [#modernisation-platform-notifications](https://moj.enterprise.slack.com/archives/C01A44RL0TC) for build notifications and Dependabot PRs
...
- Submit requests by creating a GitHub issue using the provided template. Use [this link](https://github.com/ministryofjustice/modernisation-platform/issues/new?template=out-of-hours-support-request.yml) to access the template.

- Once complete please notify the team via the [#ask-modernisation-platform](https://mojdt.slack.com/archives/C01A7QK5VM1) Slack channel once the issue is created.
...
- Provided through [Pagerduty](https://moj-digital-tools.pagerduty.com/)
- Managed through [code](https://github.com/ministryofjustice/modernisation-platform/tree/main/terraform/pagerduty)
...
On-call engineers will:

- Respond to high-priority incidents during on-call hours
- Work to resolve these incidents

If unable to resolve an issue, they will:

- Inform the affected team
- Develop a plan for resolution during normal working hours

### Critical Incidents Procedure

For critical incidents outside of regular hours:

- Email [contact-on-call-email-address-email.lj5otm6u@moj-digital-tools.pagerduty.com](mailto:contact-on-call-email-address-email.lj5otm6u@moj-digital-tools.pagerduty.com)
- Include:
  - Known facts about the incident
  - Slack channel for further communication
- The on-call person will respond via the specified Slack channel as soon as possible
...
The [#ask-modernisation-platform](https://mojdt.slack.com/archives/C01A7QK5VM1) channel is our main entry point for support.
The main purpose of the channel is to discuss the problems that people are having and help them to solve them.

We encourage people to ask questions and report problems in this channel and we’ll do the best we can to help.
We also welcome comments, opinions and any feedback regarding any of the services and the platform as a whole.
This channel can also be used to communicate to other Modernisation Platform users on topics you think that might be useful for other users.
...
[#modernisation-platform-update](https://mojdt.slack.com/archives/C02L5MCJ12N) is a low-volume channel for broadcast communications.
...
- Consider using visual cues to highlight announcements
- Commit to and maintain regular update schedules

Posts in this channel should also be forwarded to [#ask-modernisation-platform](https://mojdt.slack.com/archives/C01A7QK5VM1).

### Our on call process

Team members who are on call manage an on call rota in [PagerDuty](https://www.pagerduty.com/). The on call rota consists of a primary engineer and a secondary engineer. The primary engineer is the first point of contact. The Modernisation Platform is complex so we have a secondary engineer on call. Their role is to provide support to the primary if this is required.
...
In the event of a ‘Critical incident’ to the Modernisation Platform infrastructure affecting applications (out of support hours), please email [contact-on-call-email-address-email.lj5otm6u@moj-digital-tools.pagerduty.com](mailto:contact-on-call-email-address-email.lj5otm6u@moj-digital-tools.pagerduty.com), stating:
...
It must be emphasised that this is ONLY for ‘Critical Incidents’ and is not for out-of-hours application or development support.

## Documentation

We maintain documentation in all of our GitHub repositories.

The [Modernisation Platform repository](https://github.com/ministryofjustice/modernisation-platform) is the starting point for our documentation.

The [Modernisation Platform User Guide](https://user-guide.modernisation-platform.service.justice.gov.uk) is our front door for users, containing concepts, guides, runbooks, and other helpful information.
