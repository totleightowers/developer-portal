...
source_path: other-topics/rds-upgrade-blockers.html.md.erb
ingested_at: "2026-02-27T16:18:16.526Z"
...
Connect to your database following the [RDS external access guide](rds-external-access) and run:
...
First, connect to your database. You'll need to use a [Cloud Platform Service Pod](cloud-platform-service-pod) or [access your RDS database externally](rds-external-access).
...
If you need to drop slots/nodes but can't connect to your database, follow the [RDS external access guide](rds-external-access) to connect via port-forwarding.
...
- [AWS RDS PostgreSQL Major Version Upgrade Process](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_UpgradeDBInstance.PostgreSQL.MajorVersion.Process) - See item #5 for logical replication restrictions
- [PostgreSQL Logical Replication](https://www.postgresql.org/docs/current/logical-replication)
- [pglogical Extension Documentation](https://github.com/2ndQuadrant/pglogical)
- [Upgrading a database version or changing the instance type](/docs/documentation/deploying-an-app/relational-databases/upgrade)
