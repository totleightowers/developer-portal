...
source_path: other-topics/aws-es-encryption-migration.html.md.erb
ingested_at: "2026-02-27T16:18:16.504Z"
...
For more details on Elasticsearch REST APIs see [ES API](https://www.elastic.co/guide/en/elasticsearch/reference/current/rest-apis).
...
For more details on backup snapshots and restore, see [aws documentation](https://docs.aws.amazon.com/elasticsearch-service/latest/developerguide/es-managedomains-snapshots)
