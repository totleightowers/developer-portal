...
source_path: other-topics/apiversion-changes-cronjob-k8s-1-25.html.md.erb
...
Cloud Platform users must ensure any CronJob manifests are migrated to use the `batch/v1` API version, which is supported on our current cluster version (v1.32 as of writing).
...
For additional information on creating CronJobs see [here](/docs/documentation/other-topics/Cronjobs)
