...
source_path: other-topics/sqlserver-backup-and-restore.html.md.erb
ingested_at: "2026-02-27T16:18:16.532Z"
...
Because the RDS instance is created within it's own VPC you cannot directly access it from your local machine. See [Accessing your RDS database](/docs/documentation/other-topics/rds-external-access) for how to forward traffic on port 1433 from your local machine to your RDS instance.
