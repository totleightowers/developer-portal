...
source_path: other-topics/accessing-aws-apis-and-resources-from-your-namespace.html.md.erb
ingested_at: "2026-02-27T16:18:16.499Z"
owner_slack: "#cloud-platform"
---

# 

If you've created an AWS resource in your namespace and need to access it, you will need to use [IAM roles for service accounts](https://docs.aws.amazon.com/eks/latest/userguide/iam-roles-for-service-accounts) (IRSA) and attach the service account to your pod which runs your container image.
