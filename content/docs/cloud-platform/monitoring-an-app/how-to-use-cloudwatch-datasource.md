...
source_path: monitoring-an-app/how-to-use-cloudwatch-datasource.html.md.erb
ingested_at: "2026-02-27T16:18:16.491Z"
...
Add the `ConfigMap` above to your namespace folder in the [environments repo][env-repo]. Once the ConfigMap is applied though the [Apply Pipeline](/docs/documentation/other-topics/concourse-pipelines), your dashboard should be visible in Grafana shortly.
