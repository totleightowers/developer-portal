...
source_path: getting-started/cloud-platform-cli.html.md.erb
ingested_at: "2026-02-27T16:18:16.480Z"
...
If you don't use [Homebrew](https://brew.sh), you can manually install the Cloud Platform CLI.
...
* [Adding a container repository to your namespace](#adding-a-container-repository-to-your-namespace)
...
* `git add` and `git commit` the new files, and raise a PR
    ...
    Send a message to the [#ask-cloud-platform](https://mojdt.slack.com/archives/C57UPMZLY)
    channel to ask for a review of the PR.
...
In order to access your environments you need to [authenticate](./kubectl-config) and use kubectl to connect to the cluster
...
In the root of your local copy of the [`cloud-platform-environments`](https://github.com/ministryofjustice/cloud-platform-environments) repository:

1. `cd` into your namespace's folder
2. Run `cloud-platform environment ecr create`
3. Create a new branch, commit and push the changes
...
You should then follow the [Authenticating to your container repository](/documentation/deploying-an-app/container-repositories/create.html#authenticating-to-your-container-repository) guide to authenticate and push an image to your container repository.
...
namespace called `rds-postgresql-instance-output`. This secret contains the credentials
...
namespace called `s3-bucket-output`. This secret contains the credentials
...
on your RDS instance, you will need to [create a service account and a service pod to exec into](/docs/documentation/other-topics/cloud-platform-service-pod)
...
[GitHub releases]: https://github.com/ministryofjustice/cloud-platform-cli/releases
