...
ingested_at: "2026-02-27T16:18:16.481Z"
...
Once you have completed this guide, you will be able to [add AWS resources](/docs/documentation/deploying-an-app/add-aws-resources) to your service, such as databases and ECR repositories, and perform `kubectl` commands against your namespace.
...
- have the [Cloud Platform CLI](/docs/documentation/getting-started/cloud-platform-cli) installed
...
2. Use the [Cloud Platform CLI](/docs/documentation/getting-started/cloud-platform-cli) to create your namespace

    ```sh
    $ cloud-platform environment create
    ```

    The CLI will prompt you for details about your namespace, and automatically create the [appropriate Kubernetes and Terraform files](/docs/documentation/reference/namespace-definition-files) in the correct location. Your namespace must meet the Ministry of Justice's [guidance on naming things](https://technical-guidance.service.justice.gov.uk/documentation/standards/naming-things).
...
6. After your pull request is merged, the [Apply pipeline](/docs/documentation/other-topics/concourse-pipelines) will create your namespace in the cluster
...
- [authenticate to the cluster](/docs/documentation/getting-started/kubectl-config) and [use `kubectl` to access your environment](/docs/documentation/other-topics/quick-reference)
- [add AWS resources to your service](/docs/documentation/deploying-an-app/add-aws-resources), like databases and ECR repositories, and [access the AWS console](/docs/documentation/getting-started/accessing-the-cloud-console)
- follow the [Deploying a 'Hello World' application](/docs/documentation/deploying-an-app/helloworld-app-deploy) guide
