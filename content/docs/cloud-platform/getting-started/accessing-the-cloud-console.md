...
source_path: getting-started/accessing-the-cloud-console.html.md.erb
ingested_at: "2026-02-27T16:18:16.479Z"
...
The [Connecting to the Cloud Platform’s Kubernetes cluster](/docs/documentation/getting-started/kubectl-config) includes how to do this:
...
- Not all AWS resources support attribute-based access control. You can find out which resources AWS supports by checking the "Authorization based on tags" column in [AWS services that work with IAM](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-services-that-work-with-iam).
...
This issue is covered in our Cloud Platform runbooks [here](https://runbooks.cloud-platform.service.justice.gov.uk/debugging-aws-console-access).
