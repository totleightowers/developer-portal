...
source_path: deploying-an-app/add-secrets-to-deployment.html.md.erb
ingested_at: "2026-02-27T16:18:16.458Z"
...
- You have a [namespace created on the Cloud Platform.](/docs/documentation/getting-started/env-create)
- You have enabled [AWS console](/docs/documentation/getting-started/accessing-the-cloud-console) access to view AWS resources created in your namespace.
...
2. **Store the secret value using AWS console**
    ...
    Login to the [AWS console](/docs/documentation/getting-started/accessing-the-cloud-console), search for `Secrets Manager` and navigate to the secret created in the previous step.
