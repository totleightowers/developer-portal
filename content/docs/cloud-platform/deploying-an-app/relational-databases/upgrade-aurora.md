...
source_path: deploying-an-app/relational-databases/upgrade-aurora.html.md.erb
ingested_at: "2026-02-27T16:18:16.476Z"
...
[Postgresql](https://docs.aws.amazon.com/AmazonRDS/latest/PostgreSQLReleaseNotes/postgresql-release-calendar)
 and [MySQL](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/MySQL.Concepts.VersionMgmt) 
...
1. Check if your current **and** new major database version supports the instance type you're currently using by reading [Supported DB instance classes](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/Concepts.DBInstanceClass).
...
1. Check if your current **and** new major database version supports the instance type you're currently using by reading
    [Supported DB instance classes](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/Concepts.DBInstanceClass)
