...
source_path: deploying-an-app/relational-databases/upgrade.html.md.erb
ingested_at: "2026-02-27T16:18:16.477Z"
owner_slack: "#cloud-platform"
---

# 
> <span style="color: green;"> **INFORMATION**: Postgres 18 is now supported! Please see [here](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_UpgradeDBInstance.PostgreSQL.MajorVersion) for AWS guidance on major upgrade pathways</span>
...
> **Important for PostgreSQL databases with logical replication:** If your database has `rds.logical_replication` enabled, check the [RDS upgrade blockers troubleshooting guide](/docs/documentation/other-topics/rds-upgrade-blockers) before upgrading to avoid upgrade failures caused by logical replication slots or pglogical nodes.
...
- The automatic minor version upgrade schedule is determined by your RDS instance's maintenance window. You can read more about maintenance windows in the [AWS RDS documentation](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_UpgradeDBInstance.Maintenance). This schedule can also be managed
...
You should refer to the end-of-life schedule for major and minor versions for [PostgreSQL](https://docs.aws.amazon.com/AmazonRDS/latest/PostgreSQLReleaseNotes/postgresql-release-calendar), [MariaDB](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/MariaDB.Concepts.VersionMgmt), [Microsoft SQL Server](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/SQLServer.Concepts.General.VersionSupport), and [MySQL](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/MySQL.Concepts.VersionMgmt) to understand your upgrade paths. Typically, you will be able to upgrade to the latest minor version available on RDS.
...
3. Check if your current **and** new major database version supports the instance type you're currently using by reading [Supported DB engines for DB instance classes](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Concepts.DBInstanceClass.Support)
...
You should refer to the major version upgrade paths for [PostgreSQL](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_UpgradeDBInstance.PostgreSQL), [MariaDB](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_UpgradeDBInstance.MariaDB), [Microsoft SQL Server](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/SQLServer.Concepts.General.VersionSupport), and [MySQL](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_UpgradeDBInstance.MySQL) to understand your upgrade paths from your current database engine version.
