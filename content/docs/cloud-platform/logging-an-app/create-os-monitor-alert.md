...
source_path: logging-an-app/create-os-monitor-alert.html.md.erb
ingested_at: "2026-02-27T16:18:16.487Z"
...
After merging PR, login to the [AWS console](/docs/documentation/getting-started/accessing-the-cloud-console), search for `Secrets Manager` and navigate to the secret created in the previous step.
...
You may refer to our user guide [secret section](/docs/documentation/deploying-an-app/add-secrets-to-deployment) for more information.
