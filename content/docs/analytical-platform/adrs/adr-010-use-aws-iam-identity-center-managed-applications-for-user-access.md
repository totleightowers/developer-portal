...
source_path: adrs/adr-010-use-aws-iam-identity-center-managed-applications-for-user-access.html.md.erb
ingested_at: "2026-02-27T17:24:05.270Z"
---
...
[AWS IAM Identity Center](https://docs.aws.amazon.com/singlesignon/latest/userguide/what-is) is integrating with Entra ID. We can simplify logon and access to the Analytical Platform by making use of [customer managed application's](https://docs.aws.amazon.com/singlesignon/latest/userguide/customermanagedapps) registered with Identity Center for our users.

## Decision

  We will use a [customer managed application](https://docs.aws.amazon.com/singlesignon/latest/userguide/customermanagedapps) registered with AWS Identity Center to authenticate and authorise users access to Analytical Platform and [AWS managed applications](https://docs.aws.amazon.com/singlesignon/latest/userguide/awsapps).

## Consequences

### General consequences

- [Trusted identity propagation](https://docs.aws.amazon.com/singlesignon/latest/userguide/trustedidentitypropagation) will authorise access to AWS resources based on the user’s identity context and securely share the user’s identity context with other AWS services.
