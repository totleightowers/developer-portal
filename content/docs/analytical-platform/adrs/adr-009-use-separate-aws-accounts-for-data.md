...
source_path: adrs/adr-009-use-separate-aws-accounts-for-data.html.md.erb
...
- We will define [Service Control Policies](https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies_scps) against [AWS Organizations](https://docs.aws.amazon.com/organizations/latest/userguide/orgs_introduction)
