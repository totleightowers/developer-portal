...
title: ADR-005 Use AWS QuickSight-for-data-visualisation
last_reviewed_on: 2024-12-19
review_in: 6 months
source_repo: ministryofjustice/analytical-platform
source_path: adrs/adr-005-use-aws-quicksight-for-data-visualisation.html.md.erb
...
- Serverless BI service, meaning we do not need to patch or maintain and [security and compliance](https://docs.aws.amazon.com/quicksight/latest/user/QS-compliance) is maintained by AWS
